export const presaleAbi = [
    ...
    inputs: [
      {
        ...
        internalType: "struct DobifyPresale.AddPhase[]",
        name: "_addPhase",
        type: "tuple[]",
      },
    ],
  ...
  {
    inputs: [{ internalType: "uint256[]", name: "_phases", type: "uint256[]" }],
    name: "claimAll",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "uint256", name: "fundsRaisedEth", type: "uint256" },
          { internalType: "uint256", name: "tokenPriceInUsd", type: "uint256" },
          { internalType: "uint256", name: "claimStart", type: "uint256" },
          { internalType: "bool", name: "saleStatus", type: "bool" },
        ],
        internalType: "struct DobifyPresale.Phase[]",
        name: "",
        type: "tuple[]",
      },
    ],
